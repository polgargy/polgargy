export const state = () => ({
  ...
  about: {
    text: {
      hu:
        '<p>Már gyerekkorom óta érdekelt az informatika, mindig is fogékony voltam a kreatív, logikán alapuló feladatokra. Szerettem a kihívásokat, illetve új, számomra érdekes technológiákat megismerni.</p><p>2014 óta dolgozom a webfejlesztés területén, ezalatt az idő alatt számtalan érdekes projektben volt részem. Lehetőségem volt tapasztalatot szerezni nagyobb cégnél és kisebb webfejlesztő ügynökségnél egyaránt. Három éve pedig szabadúszóként dolgozom.</p><p>Legyen szó kezdő vagy nagy múlttal rendelkező vállalkozásról, ha weboldalra van szüksége, bízom benne, hogy bennem megtalálja a számításait.</p>',
      en:
  ...
  services: [
    {
      ...
      text: {
        hu: 'Webdesign, online grafikai anyagok tervezése',
        en: 'Web design, online graphic design'
      }
    },
    {
